---
sidebar_position: 7
slug: /courses/books/paul-graham/avg
title: "Beating the Averages"
description: "Paul Graham essay: Beating the Averages"
---
# Beating the Averages

Source: [https://paulgraham.com/avg.html](https://paulgraham.com/avg.html)
...
People sometimes ask me if Yahoo Store still uses Lisp. Yes, all the Lisp code is still there. Yahoo has server-side software written in all five of the languages Eric Raymond recommends to hackers. **The Blub Paradox**
