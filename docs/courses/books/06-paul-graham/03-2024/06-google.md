---
sidebar_position: 6
slug: /courses/books/paul-graham/google
title: "How to Start Google"
description: "Paul Graham essay: How to Start Google"
---
# How to Start Google
...
It's more exciting to work on your own project than someone else's. And you can also get a lot richer. In fact, this is the standard way to get [really rich](https://paulgraham.com/richnow.html). If you look at the lists of the richest people that occasionally get published in the press, nearly all of them did it by starting their own companies.
...
Let's suppose you're 22 and you've succeeded: You're now really good at some technology. How do you get [startup ideas](https://paulgraham.com/startupideas.html)? It might seem like that's the hard part. Even if you are a good programmer, how do you get the idea to start Google?
