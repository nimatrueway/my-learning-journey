---
sidebar_position: 1
slug: /courses/books/paul-graham/spam
title: "A Plan for Spam"
description: "Paul Graham essay: A Plan for Spam"
---
# A Plan for Spam

Source: [https://paulgraham.com/spam.html](https://paulgraham.com/spam.html)
...
[1] The examples in this article are translated into Common Lisp for, believe it or not, greater accessibility. The application described here is one that we wrote in order to test a new Lisp dialect called [Arc](https://paulgraham.com/arc.html) that is not yet released.
