---
sidebar_position: 4
slug: /courses/books/paul-graham/aord
title: "Default Alive or Default Dead?"
description: "Paul Graham essay: Default Alive or Default Dead?"
---
...
The reason is a phenomenon I wrote about earlier: the [fatal pinch](https://paulgraham.com/pinch.html). The fatal pinch is default dead + slow growth + not enough time to fix it. And the way founders end up in it is by not realizing that's where they're headed.
