...
slug: /courses/books/paul-graham/bubble
title: "What the Bubble Got Right"
description: "Paul Graham essay: What the Bubble Got Right"
---
...
What made the options valuable, for the most part, is that they were options on the stock of [startups](https://paulgraham.com/start.html). Startups were not of course a creation of the Bubble, but they were more visible during the Bubble than ever before.
...
As I wrote in [Hackers & Painters](https://paulgraham.com/hackpaint.html), employees seem to be most productive when they're paid in proportion to the wealth they generate. And the advantage of a startup—indeed, almost its raison d'etre—is that it offers something otherwise impossible to obtain: a way of *measuring* that.
...
Or more precisely, a huge increase in [variation](https://paulgraham.com/gh.html) in productivity. Technology is a lever. It doesn't add; it multiplies. If the present range of productivity is 0 to 100, introducing a multiple of 10 increases the range from 0 to 1000.
