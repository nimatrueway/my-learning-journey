---
sidebar_position: 1
slug: /courses/books/paul-graham/progbot
title: "Programming Bottom-Up"
description: "Paul Graham essay: Programming Bottom-Up"
---
# Programming Bottom-Up

Source: [https://paulgraham.com/progbot.html](https://paulgraham.com/progbot.html)

1993

*(This essay is from the introduction to*[On Lisp](https://paulgraham.com/onlisp.html)*.)* The red text explains the origins of [Arc](https://paulgraham.com/arc.html)'s name.
...
Bottom-up design makes programs easier to read. %It yields the same result as top-down design %with foresight---the foresight to arrange the branches near the %root of the tree so that among the leaves there is as little %duplication of effort as possible. An instance of this type of abstraction asks the reader to understand a general-purpose operator; an instance of functional abstraction asks the reader to understand a special-purpose subroutine. [1]
